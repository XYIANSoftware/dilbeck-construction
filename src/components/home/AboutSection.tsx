...
export function AboutSection() {
  return (
    <section className="w-full flex flex-col gap-4 py-6 px-4 mt-4 glass-effect rounded-lg shadow justify-items-center justify-content-center align-items-center text-center">
